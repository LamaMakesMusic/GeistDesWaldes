...
namespace GeistDesWaldes.Attributes
{
    ...
    {
        public static implicit operator CustomRuntimeResult(CustomRuntimeResult<T> crr) => new CustomRuntimeResult(crr.Error, crr.Reason);
        public static implicit operator CustomRuntimeResult<T>(CustomRuntimeResult crr) => new CustomRuntimeResult<T>(crr.Error, crr.Reason);
