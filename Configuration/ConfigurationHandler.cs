...
namespace GeistDesWaldes.Configuration
{
    public static class ConfigurationHandler
    {
        ...
        public static readonly ConcurrentDictionary<ulong, ServerConfiguration> Configs = new ConcurrentDictionary<ulong, ServerConfiguration>();
        public static readonly ConcurrentDictionary<ulong, RuntimeConfiguration> RuntimeConfig = new ConcurrentDictionary<ulong, RuntimeConfiguration>();
