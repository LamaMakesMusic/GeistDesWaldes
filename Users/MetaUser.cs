...
namespace GeistDesWaldes.Users
{
    public class MetaUser : IUser
    {
        ...
        public Task<IDMChannel> CreateDMChannelAsync(RequestOptions options = null) => FrontUser.CreateDMChannelAsync(options);
        ...
        public string GetAvatarUrl(ImageFormat format = ImageFormat.Auto, ushort size = 128) => FrontUser.GetAvatarUrl();
        public string GetDefaultAvatarUrl() => FrontUser.GetDefaultAvatarUrl();
