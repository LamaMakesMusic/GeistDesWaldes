...
public class CitationModule : ModuleBase<CommandContext>, ICommandModule
{
    ...
    [RequireUserPermission(GuildPermission.Administrator, Group = "CitationsAdminPermission")]
    [RequireUserPermission(GuildPermission.ManageChannels, Group = "CitationsAdminPermission")]
