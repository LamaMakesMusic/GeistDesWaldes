...
public class CustomCommandModule : ModuleBase<CommandContext>, ICommandModule
{
    ...
    [RequireUserPermission(GuildPermission.Administrator, Group = "CustomCommandAdmin")]
    [RequireUserPermission(GuildPermission.ManageChannels, Group = "CustomCommandAdmin")]
    ...
    public class CustomCommandModPermissionSubModule : ModuleBase<CommandContext>, ICommandModule
    {
        ...
        public async Task<RuntimeResult> AddCommand(string commandName, string[] commands, [Summary("Category")] string category = "null", [Summary("Embed on execution?")] bool embed = false, [Summary("Cooldown in Seconds")] float cooldown = 0, [Summary("Price")] int fee = 0, IChannel channel = null)
        {
            ...
            {
                CustomCommand newCommand = new(Server, commandName, parseResult.ResultValue, channel != null ? channel.Id : 0, cooldown, fee, embed);
        ...
        {
            return await EditCommand(commandName, cooldown);
        }
        ...
        {
            return await EditCommand(commandName, fee: fee);
        }
        ...
        {
            return await EditCommand(commandName, commands: commands, channel: channel);
        }
        ...
        {
            return await EditCommand(commandName, category: categoryName);
        }
        ...
        {
            return await EditCommand(commandName, embed: embed);
        }
        ...
        {
            return await EditCommand(commandName, showInfo: showInfo);
        }
