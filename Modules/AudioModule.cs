...
{
    [RequireUserPermission(GuildPermission.Administrator, Group = "AudioPermissions")] [RequireUserPermission(GuildPermission.ManageChannels, Group = "AudioPermissions")]
