    ...
    private async Task RescheduleToNextRepetition()
    {
        ...
        switch (Repetition)
        {
            ...
            case RepetitionOption.Monthly:
                nextTime = new DateTime(nextTime.Year, nextTime.Month == 12 ? 1 : nextTime.Month + 1, ExecutionTime.Day, ExecutionTime.Hour, ExecutionTime.Minute, ExecutionTime.Second);
                break;

            case RepetitionOption.Yearly:
                nextTime = new DateTime(ExecutionTime.Year + 1, ExecutionTime.Month, ExecutionTime.Day, ExecutionTime.Hour, ExecutionTime.Minute, ExecutionTime.Second);
                break;
        }
