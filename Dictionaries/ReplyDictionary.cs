...
public class ReplyDictionary
{
    ...
    public static string GetOutputTextForEnum(Enum enumeration)
    {
        ...
        if (enumeration is CurrencyCustomization.ToStringType toStringType)
        {
            switch (toStringType)
            {
                case CurrencyCustomization.ToStringType.Points:
                    return "Punkte Übersicht";
                case CurrencyCustomization.ToStringType.NotEnough:
                    return "Nicht genug Punkte";
                case CurrencyCustomization.ToStringType.Transfer:
        ...
        if (enumeration is UserCallbackDictionary.DiscordCallbackTypes discordCallbacks)
        {
        ...
        if (enumeration is UserCallbackDictionary.TwitchCallbackTypes twitchCallbacks)
        {
